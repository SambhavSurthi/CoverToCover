        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex-1 md:flex md:items-center md:gap-12">
              <Link to="/customer" className="block text-blue-600">
                <span className="sr-only">Home</span>
                <h1 className="font-bold text-xl font-mono ">CoverToCover</h1>
              </Link>
            </div>
              ...
              <nav aria-label="Global" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  <li className="hover:bg-gray-200 p-2 rounded-4xl" >
                    <Link
                      to="/customer/cart" // Update the path as needed
                  ...
                  <li>
                    <Link
                      to="/customer/history" // Update the path as needed
                      className="text-gray-500 text-lg transition hover:text-gray-500/75"
                    >
                      Order History
                    </Link>
              ...
              <div className="hidden md:relative md:block">
                ...
                {isOpen && (
                  <div className="absolute end-0 z-10 mt-0.5 w-56 divide-y divide-gray-100 rounded-md border border-gray-100 bg-white shadow-lg">
                    <div className="p-2">
                      <Link
                        to="/customer/profile" // Update the path as needed
